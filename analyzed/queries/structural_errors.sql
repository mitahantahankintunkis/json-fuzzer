...
CREATE TEMP TABLE errors AS
	...
	WHERE
		(
		  ((output0 == 'KEY_NOT_FOUND' AND output1 == '2')
		  OR (output0 == 'KEY_NOT_FOUND' AND output1 == '3')
		  OR (output0 == 'PARSE_ERROR' AND output1 == '2')
		  OR (output0 == 'PARSE_ERROR' AND output1 == '3')))
		OR
		(
		((output0 == '2' AND output1 == 'KEY_NOT_FOUND')
		  OR (output0 == '2' AND output1 == 'PARSE_ERROR')
		  OR (output0 == '3' AND output1 == 'KEY_NOT_FOUND')
		  OR (output0 == '3' AND output1 == 'PARSE_ERROR')));
...
CREATE TEMP TABLE results AS
	...
	WHERE 1==1
		...
		-- filter results that do not produce an error with other parsers
		AND EXISTS (SELECT 1 FROM errors AS b WHERE a.json == b.json LIMIT 1)
